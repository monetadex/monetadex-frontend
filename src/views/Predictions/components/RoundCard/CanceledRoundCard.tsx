...
import { Card, CardBody, Text, Flex, BlockIcon, LinkExternal } from '@monetadex/uikit'
      ...
      <CardBody p="16px">
        ...
        <RoundResultBox>
          <Flex flexDirection="column" alignItems="center">
            ...
            <LinkExternal href="https://monetadex.gitbook.io/monetadex/products/prediction" external>
              {t('Learn More')}
            </LinkExternal>
          </Flex>
        </RoundResultBox>
