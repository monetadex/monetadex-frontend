...
import { Box, Flex, Text, Heading, useMatchBreakpoints, Link } from '@monetadex/uikit'
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                ...
                <InlineLink href="https://monetadex.gitbook.io/monetadex/tokenomics/cake/cake-tokenomics">
                  {t('CAKE Tokenomics')}
                </InlineLink>
              </Text>
            </li>
      ...
      <Flex justifyContent="center" alignItems="center" flexDirection={['column', 'column', 'row']}>
        ...
        <Flex maxWidth="300px" flexDirection="column">
          ...
          <Text>
            ...
            <InlineLink href="https://monetadex.gitbook.io/monetadex/products/lottery/lottery-guide">
