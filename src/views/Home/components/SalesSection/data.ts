...
export const swapSectionData: SalesSectionProps = {
  ...
  secondaryButton: {
    to: 'https://monetadex.gitbook.io/monetadex/',
    text: 'Learn',
    external: true,
  },
  images: {
...
export const earnSectionData: SalesSectionProps = {
  ...
  secondaryButton: {
    to: 'https://monetadex.gitbook.io/monetadex/products/yield-farming',
    text: 'Learn',
    external: true,
  },
  images: {
...
export const cakeSectionData: SalesSectionProps = {
  ...
  secondaryButton: {
    to: 'https://monetadex.gitbook.io/monetadex/tokenomics/cake',
    text: 'Learn',
    external: true,
  },
